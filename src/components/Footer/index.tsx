...
function FooterMenuLink({
  ...
  return (
    <SectionHashLink
      href={href}
      sectionId={sectionId}
      className={`${styles.menuLink}${isOrder ? ` ${styles.menuLinkOrder}` : ""}`}
    >
      {label}
...
export function Footer() {
  ...
  return (
    <FadeInSection className={styles.fadeInWrap}>
        ...
        <div className={styles.shell}>
          <div className={styles.inner}>
            <div className={styles.layout}>
              <section className={styles.brandBlock} aria-label="아트디어 소개">
                <div className={styles.brandLogo}>
                  <ArtDearLogo
                    height={HEADER_LOGO_HEIGHT}
                    className={styles.brandLogoLink}
                    imageClassName={styles.brandLogoImage}
                  />
                </div>
